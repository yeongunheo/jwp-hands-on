...
class ThreadPoolsTest {
    ...
    void testNewFixedThreadPool() {
        ...
        final int expectedPoolSize = 2; // 현재 작업 중인 스레드의 수
        final int expectedQueueSize = 1; // 현재 대기 중인 스레드의 수
    ...
    void testNewCachedThreadPool() {
        ...
        final int expectedQueueSize = 0; // 내부적으로 SynchronousQueue가 사용되므로 큐 사이즈는 항상 0이다.
